                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form role="form" id="providerForm">
                            ...
                            <div class="form-group">
                                <input type="text" id="telefono_prov" placeholder="Teléfono" class="form-control">
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form role="form" id="providerFormEdit">
                            ...
                            <div class="form-group">
                                <input type="text" id="telefono_prov_edit" placeholder="Teléfono de REP" class="form-control">
                            </div>
                            <div class="row mx-auto">
                                <div class="w-50 p-1">
