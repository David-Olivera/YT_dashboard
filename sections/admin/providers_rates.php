                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" class="form-control-plaintext form-control-sm pl-2"  placeholder="$0.00" id="<?php echo 'S'.$al->{'id_zone'}.'1'; ?>" data-update="<?php echo $rate_shared_1c->{'id_rate_provider'}; ?>" value="<?php echo $rate_shared_1c->{'cost_service'}; ?>">
                                        </div>
                                        ...
                                        <div class="col-md-8 ">
                                            ...
                                            <input type="text"  class="form-control-plaintext form-control-sm pl-2"  placeholder="$0.00" id="<?php echo 'P'.$al->{'id_zone'}.'4'; ?>" data-update="<?php echo $rate_private_4p->{'id_rate_provider'}; ?>" value="<?php echo $rate_private_4p->{'cost_service'}; ?>">
                                        </div>
                                        <div class="col-md-4 text-center ">
                                            <small>4CAP</small>
                                        </div>
                                        <div class="col-md-8 ">
                                            ...
                                            <input type="text"  class="form-control-plaintext form-control-sm pl-2"  placeholder="$0.00" id="<?php echo 'P'.$al->{'id_zone'}.'6'; ?>" data-update="<?php echo $rate_private_6p->{'id_rate_provider'}; ?>" value="<?php echo $rate_private_6p->{'cost_service'}; ?>">
                                        </div>
                                        <div class="col-md-4 text-center">
                                            <small>6CAP</small>
                                        </div> 
                                        <div class="col-md-8 ">
                                            ...
                                            <input type="text"  class="form-control-plaintext form-control-sm pl-2"  placeholder="$0.00" id="<?php echo 'P'.$al->{'id_zone'}.'8'; ?>" data-update="<?php echo $rate_private_8p->{'id_rate_provider'}; ?>" value="<?php echo $rate_private_8p->{'cost_service'}; ?>">
                                        </div>
                                        <div class="col-md-4 text-center">
                                            <small>8CAP</small>
                                        </div>
                                        <div class="col-md-8 ">
                                            ...
                                            <input type="text"  class="form-control-plaintext form-control-sm pl-2"  placeholder="$0.00" id="<?php echo 'P'.$al->{'id_zone'}.'10'; ?>" data-update="<?php echo $rate_private_10p->{'id_rate_provider'}; ?>" value="<?php echo $rate_private_10p->{'cost_service'}; ?>">
                                        </div>
                                        <div class="col-md-4 text-center">
                                            <small>10CAP</small>
                                        </div>
                                        ...
                                        <div class="col-md-8 ">
                                            ...
                                            <input type="text"  class="form-control-plaintext form-control-sm pl-2"  placeholder="$0.00" id="<?php echo 'L'.$al->{'id_zone'}.'6'; ?>" data-update="<?php echo $rate_private_6l->{'id_rate_provider'}; ?>" value="<?php echo $rate_private_6l->{'cost_service'}; ?>">
                                        </div>
                                        <div class="col-md-4 text-center">
                                            <small>6CAP</small>
                                        </div>
